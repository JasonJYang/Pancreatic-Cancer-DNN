...
from data_loader.data_loaders import PC_PCADataLoader as module_data
from model.model import PCADNN as module_arch
...
def main(config):
    ...
    feature_num = config['data_loader']['args']['n_pc']
